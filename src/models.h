...
List MSARmdl(arma::vec Y, int ar, int k, bool msmu = 1, bool msvar = 1, int maxit = 10000, double thtol = 1.e-6, bool getHess = 0, int max_init = 500, int use_diff_init = 1, Nullable<NumericVector> init_value = R_NilValue);
