...
#'
#' @export
argrid_MSARmdl_cpp <- function(mu, sig, k, ar) {
    .Call(`_MSTest_argrid_MSARmdl_cpp`, mu, sig, k, ar)
}
...
#'
#' @export
argrid_MSVARmdl_cpp <- function(mu, sigma, k, ar) {
    .Call(`_MSTest_argrid_MSVARmdl_cpp`, mu, sigma, k, ar)
}
